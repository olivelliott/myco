...
- ✅ **v5.0 Feature Parity & Differentiation** — Phases 18-23 (shipped 2026-03-29)
- ✅ **v6.0 Proactive Knowledge & Onboarding** — Phases 24-28 (shipped 2026-03-29)
...
<details>
<summary>✅ v5.0 Feature Parity & Differentiation (Phases 18-23) — SHIPPED 2026-03-29</summary>

- [x] Phase 18: Schema Foundation (1/1 plans) — completed 2026-03-27
- [x] Phase 19: Temporal Versioning + Dedup Resolution (3/3 plans) — completed 2026-03-27
- [x] Phase 20: Relationship Strength Scoring (1/1 plans) — completed 2026-03-27
- [x] Phase 21: Memory Importance Decay (2/2 plans) — completed 2026-03-27
- [x] Phase 22: Core Refactor + REST Write Routes + Import/Export (3/3 plans) — completed 2026-03-29
- [x] Phase 23: Auto-Extraction + Incremental Consolidation (2/2 plans) — completed 2026-03-29

</details>

<details>
<summary>✅ v6.0 Proactive Knowledge & Onboarding (Phases 24-28) — SHIPPED 2026-03-29</summary>

- [x] Phase 24: Context Scoping Schema (1/1 plans) — completed 2026-03-29
- [x] Phase 25: Session-Start Recall (1/1 plans) — completed 2026-03-29
- [x] Phase 26: Project Onboarding (2/2 plans) — completed 2026-03-29
- [x] Phase 27: Workflow Rules and Knowledge Correction (2/2 plans) — completed 2026-03-29
- [x] Phase 28: User Preferences (2/2 plans) — completed 2026-03-29
...
<!-- v6.0 phase details archived to .planning/milestones/v6.0-ROADMAP.md -->
